            ...
            <div className="p-8 md:p-12">
              <header className="text-center mb-8">
                ...
                <p className="text-gray-700 text-lg">
                  Ready to transform your space with professional tile
                  installation? Contact us today for a personalized quote.
                </p>
              </header>
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-600">
                  Our team is ready to discuss your project requirements and
                  provide you with a detailed, competitive quote.
                </p>
              </div>
            </div>
          </div>
